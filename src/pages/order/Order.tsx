...
import { AccountCircleOutlined, CreditCard } from "@mui/icons-material";
...
const Order = () => {
  ...
  const handlePurchase = (values: any) => {
    navigate("/order/complete", {
      state: { products: products, formValues: values },
    });
  ...
  if (products.length === 0) {
    return (
      <div className="order-wrapper p-12 max-[800px]:p-4">
        <NotFound />
      </div>
    );
  } else
