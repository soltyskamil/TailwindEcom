...
const AccountPanel = ({ name }: AccountPanelProps) => {
  ...
  return (
    <div className="account-panel-wrapper grid grid-cols-[auto_1fr]">
      <div className="account-panel w-max p-8 flex flex-col gap-0.5  border-r-2 border-r-neutral-300">
